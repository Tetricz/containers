...
docker buildx build --build-arg NC_VERSION="28.0.1" --platform=linux/amd64 -t tetricz/nextcloud:amd64-28 . --load
...
docker manifest create tetricz/nextcloud:latest tetricz/nextcloud:amd64-28 --amend
